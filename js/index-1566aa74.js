...
const useBoostStore = create( ( e, t ) => ( {
  ...
  partnerTasksData = [
    ...
    },
    {
      ...
      type: "challengeCompleted",
      title: "Arbuz Fest",
      icon: "https://yescoin.space/clicker/task-arbuz.png?2",
      imageSize: "72",
      minLeagueId: 2,
      challengeId: 151,
      imageType: "cover-src",
  ...
  specialTasksData = [
    ...
    },
    {
      ...
      type: "challengeCompleted",
      title: "OKX TONомания",
      icon: "https://yescoin.space/clicker/task-okx.png",
      imageSize: "72",
      minLeagueId: 2,
      challengeId: 104,
      imageType: "cover-src",
    ...
    },
    {
      ...
      coins: 2e5,
      isCompleted: !1,
      locale: [ "az", "kk", "tg", "tk", "uz", "uk", "ua" ],
    },
    {
      id: 5,
      type: "challengeCompleted",
      title: "Egg Fight Club",
      icon: "https://yescoin.space/clicker/task-egg-fight-club.png",
      imageSize: "72",
      minLeagueId: 2,
      challengeId: 111,
      imageType: "cover-src",
  ...
  useTaskStore = create( ( e, t ) => ( {
    ...
    onboardingTasks: [],
    fetchTasks: async () => {
      const { ok: s, data: n } = await fetchAllCompletedTasksApi(),
        o = onboardingTasksData.map( ( l ) => ( n.find( ( d ) => d.task.type === l.type ) ? { ...l, isCompleted: !0 } : l ) ),
        r = leagueTasksData.map( ( l ) => ( n.find( ( d ) => d.task.type === l.type ) ? { ...l, isCompleted: !0 } : l ) ),
        a = specialTasksData,
        c = partnerTasksData,
        i = dailyTasksData.map( ( l ) => ( { ...l, completions: n.filter( ( d ) => d.taskId === l.id ).length } ) );
...
const root$3 = "_root_9azk3_2",
  ...
  EarnPage = () => {
    const e = window.Telegram.WebApp,
      ...
      { isLoaded: a, fetchBoosts: c } = useBoostStore(),
      { userProfile: i, score: l, fetchClickerUserProfile: d } = useClickerStore(),
      { onboardingTasks: _, fetchTasks: p, leagueTasks: m, specialTasks: u, partnerTasks: y, isLoaded: f } = useTaskStore();
    reactExports.useEffect( () => {
      i && ( c(), p() );
    }, [ i ] );
    const g = i && a && f,
      k = _.sort( ( w, q ) => ( w.id < q.id ? 1 : -1 ) ).sort( ( w ) => ( w.isCompleted ? 1 : -1 ) ),
      ...
      v = [ ...u ];
    x && v.push( ...x );
    const j = reactExports.useMemo( () => sortPartners( v, h, $ ), [ u, m, h, $ ] ),
      L = k.filter( ( w ) => !w.isCompleted ).length === 0,
      B = j.filter( ( w ) => !w.isCompleted ).length === 0,
    ...
    const I = ( w ) => {
      ...
      T = jsxs( Fragment, {
        children: [
          ...
          jsx( Content, {
            padding: "0-0-24",
            children: jsx( List, { type: "inset", children: k.map( ( w ) => jsx( TaskEarn, { task: w, userBoosts: [], userBalance: l }, `onboarding-${w.id}` ) ) } ),
          } ),
        ],
      } ),
      z = jsxs( Fragment, {
        children: [
          ...
          jsx( Content, {
            padding: "0-0-24",
            children: jsx( Carousel, { list: j.map( ( w ) => jsx( TaskEarn, { userBoosts: [], task: w, userBalance: l, onClick: () => { } }, `special-${w.id}` ) ), slideSize: 4 } ),
          } ),
        ],
      } );
    return jsxs( Page, {
          ...
          ? jsxs( Content, {
            ...
            children: [
              ...
              jsx( Content, {
                ...
                children: jsx( Carousel, {
                  onSlideChange: n,
                  list: C.map( ( w ) => jsx( TaskEarn, { userLeagueId: i == null ? void 0 : i.leagueId, userBoosts: [], task: w, userBalance: l, onClick: I }, `special-${w.id}` ) ),
                  slideSize: 4,
                } ),
              } ),
              L ? T : null,
