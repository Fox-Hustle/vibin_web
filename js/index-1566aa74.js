        ...
        children: [
          jsxs('div', {
            ...
            children: [jsx('div', {
              ...
              children: t
            }), s ? jsx('div', {className: styles$1e.content, children: s}) : null],
          }),
  ...
  SvgCoins = (e) =>
    reactExports.createElement(
      ...
      reactExports.createElement(
        'defs',
        null,
        reactExports.createElement('clipPath', {id: 'clip0_560_3553'}, reactExports.createElement('rect', {
          width: 28,
          height: 28,
          fill: 'white'
        }))
  ...
  SvgPicture = (e) =>
    reactExports.createElement(
      ...
      reactExports.createElement(
        'defs',
        null,
        reactExports.createElement('clipPath', {id: 'clip0_560_2446'}, reactExports.createElement('rect', {
          width: 28,
          height: 28,
          fill: 'white'
        }))
  ...
  SvgPlace = (e) =>
    reactExports.createElement(
      ...
      reactExports.createElement(
        'defs',
        null,
        reactExports.createElement('clipPath', {id: 'clip0_394_5544'}, reactExports.createElement('rect', {
          width: 30,
          height: 30,
          fill: 'white',
  ...
  SvgPremium = (e) =>
    reactExports.createElement(
      ...
      reactExports.createElement(
        ...
        reactExports.createElement('clipPath', {id: 'clip0_4980_40501'}, reactExports.createElement('rect', {
          width: 48,
          height: 48,
          fill: 'white'
        }))
  ...
  SvgStar = (e) =>
    reactExports.createElement(
      ...
      reactExports.createElement(
        'defs',
        null,
        reactExports.createElement('clipPath', {id: 'clip0_10_507'}, reactExports.createElement('rect', {
          width: 28,
          height: 28,
          fill: 'white'
        }))
  ...
  SvgSticker = (e) =>
    reactExports.createElement(
      ...
      reactExports.createElement(
        'defs',
        null,
        reactExports.createElement('clipPath', {id: 'clip0_394_5485'}, reactExports.createElement('rect', {
          width: 30,
          height: 30,
          fill: 'white',
          transform: 'translate(0.5)'
  ...
  SvgVerified = (e) =>
    reactExports.createElement(
      ...
      reactExports.createElement(
        'defs',
        null,
        reactExports.createElement('clipPath', {id: 'clip0_10_532'}, reactExports.createElement('rect', {
          width: 28,
          height: 28,
          fill: 'white'
        }))
      ...
      () =>
        React.Children.map(t, (a, c) => {
          ...
          return i === null ? null : React.cloneElement(i, {
            index: c,
            separate: s === 'separate',
            divider: i.props.divider === !1 ? !1 : c < o - 1 && s !== 'separate'
          });
        }),
      [t]
    );
  return jsx('div', {
    className: cn(styles$19.root, e, styles$19[s], n && styles$19[`spacing-child-${n}`]),
    children: r
  });
}
  ...
  return (
    reactExports.useEffect(() => {
      ...
      jsxs('div', {
        ...
        children: [i, jsx('div', {className: cn(styles$$.activeBar), style: a})]
      })
  );
}
...
function ToastProvider({children: e}) {
  ...
  return jsxs(ToastContext.Provider, {
    value: {addToast: n, removeToast: o, hideToasts: r},
    children: [jsx(ToastContainer, {toasts: t}), e]
  });
}
...
const apiHost = config$1.apiHost,
  ...
  ApiService = {
    ...
    get: async ({endpoint: e, options: t, host: s}) => await api.get(`${s || apiHost}${e}`, {
      searchParams: t,
      retry: 3,
      headers: {Auth: '1'}
    }).json(),
...
const useBoostStore = create((e, t) => ({
  ...
  fetchLeaderboard = async ({type: e, league: t, time: s, squadId: n}) => {
    const o = {};
    n && (o.id = n);
    const {ok: r, data: a} = await ApiService.get({
      options: o,
      endpoint: `/clicker/league/leaderboard/public/${e}/${t}/${s}`
    });
    if (r) {
  ...
  fetchReferralLeaderboardApi = async () => {
    ...
    if (e) {
      ...
      return {
        ok: e,
        items: n,
        rank: s.data ? s.data.rank : 0,
        score: s.data ? s.data.count : 0,
        bonus: s.data ? s.data.bonus : 0
      };
    }
    return {ok: e, items: []};
  },
  ...
  checkCompletionTaskApi = async (e, t) => {
    const {ok: s, data: n} = await ApiService.get({
      endpoint: `/public/challenge/${e}/apply/${t}`,
  ...
  useClickerStore = create((setProf, getProf) => ({
    ...
    click: () => {
      ...
      if ((turboSettings && turboSettings.expire - 2000 < Date.now() && (getProf().saveClicks(), getProf().switchTurbo(!1)), r <= 0)) {
        const a = o + r;
        setProf({
          unsavedClicks: getProf().unsavedClicks + a,
          score: getProf().score + a,
        ...
        setProf({
          unsavedClicks: getProf().unsavedClicks + o,
          score: a,
    ...
    saveClicks: async () => {
      ...
      try {
        ...
        setProf({
          hash: n.hash,
          availableToClick: n.lastAvailableCoins,
          lastMiningAt: n.lastMiningAt,
          turboTimes: n.turboTimes,
          isSaving: !1
        });
...
const background$1 = '_background_6spwk_1',
  ...
  Background = ({type: e, position: t = 'top'}) => {
    ...
    return jsxs(Content, {
      ...
      children: [jsx('div', {ref: a, className: styles$X.layer}), jsx('div', {
        ref: r,
...
function Bar({current: e, limit: t, leagueId: s}) {
  ...
  return jsx('div', {
    children: jsx('div', {
      ...
      children: jsx('div', {className: cn(styles$W.fill, s && styles$W[`skin-league-${s}`]), style: o})
    })
  });
}
        ...
        ? jsxs('div', {
          ...
          children: [
            ...
            jsx(Text, {
              ...
              align: 'center',
              color: 'white',
              children: getBoostDetails(s.type).title || s.name
            }),
            jsx(Text, {
              type: 'subheadline-1',
              margin: '0-0-16-0',
              align: 'center',
              color: 'secondary',
              children: getBoostDetails(s.type).description || s.description
            }),
            !!(s != null && s.price) &&
            jsxs('div', {
              ...
              children: [
                jsx('div', {
                  ...
                  children: beautifyMoney$2(String(s.price))
                }),
      ...
      ? jsxs(Fragment, {
        children: [
          jsx(BoostSheet, {
            ...
            onClose: o,
            boost: c,
            level: c ? getBoostLevel(c, bought) : null,
            buyBoost: buyB
          }),
          jsx(Content, {
            fadeIn: !0,
...
function BoostItem({id: e, isCompleted: t, onClick: s, isLoading: n, isDisabled: o, title: r, footer: a, before: c}) {
  return jsx(
    ListItem,
    {
      ...
      title: jsx(Text, {
        color: 'secondary',
        className: cn(o && styles$T.disabled, t && styles$T.isCompleted),
        children: r
      }),
      footer: a,
      before: c,
...
const beautifyMoney$1 = (e) => new Intl.NumberFormat('en-US').format(parseInt(e.toString())),
  beautifyLongNumber = (e = '', t = 'compact', s = 1) => new Intl.NumberFormat('en-US', {
    notation: t,
...
const getBoostDetails = (e) => (boostData[e] ? boostData[e] : {
          ...
          level !== null
            ? jsxs(Fragment, {
              children: [jsx('span', {
                ...
                children: '・'
              }), jsxs('span', {className: styles$T.level, children: [level, ' lvl']})]
            })
            : null,
        ],
      })
  ...
  BoostItemBoost = ({userLeagueId: e, boost: t, userBalance: s, currentLevel: n, onClick: o, maxLevelAchieved: r}) => {
    ...
    return jsx(BoostItem, {
      ...t,
      onClick: d,
      isDisabled: u !== BoostStatusEnum.available,
      title: f || a,
      footer: y,
      before: h,
      isCompleted: p
    ...
    jsxs('div', {
      ...
      children: [
        jsxs(Text, {
          ...
          center: !0,
          children: ['PC bad', jsx('br', {}), 'use mobile']
        }),
  ...
  Button = ({fullwidth: e, className: t, type: s = 'Blue', children: n, disabled: o = !1, onClick: r}) => {
    ...
    return jsx('button', {
      className: cn(styles$Q.root, t, styles$Q[`type${s}`], a),
      onClick: r,
      disabled: o,
      children: n
    });
...
function Carousel({
                    list: e, slideSize: t = 3, slidesPerView: s = 1.15, isDaily: n, onSlideChange: o = () => {
  }
                  }) {
    ...
    children: jsxs('div', {
      ...
      children: [
        ...
        jsx('div', {
          ...
          children: c ? jsx(Icon, {name: 'ChevronRight', className: styles$N.chevron}) : null
        }),
      ],
    }),
  });
  ...
  return jsxs(Content, {
    ...
    children: [
      jsx('div', {
        ...
        children: t || (a && e > 100 ? beautifyLongNumber(getPrefix(e).toString()) : getPrefix(e))
      }),
      jsx('div', {
...
const placeAndLeague = '_placeAndLeague_xg9t0_1',
  ...
  Progress$1 = ({value: e, maxValue: t, type: s, className: n}) => {
    ...
    return jsx('div', {
      className: cn(styles$D.progress, styles$D[`type-${s}`], n),
      children: jsx('div', {ref: a, className: styles$D.line, style: {width: `${r}%`}})
    });
  },
  star = '_star_cn5dv_1',
                    ...
                    jsx('div', {
                      ...
                      children: m.map((h, b) =>
                        jsxs(
                          ...
                          {
                            type: 'basic',
                            className: cn(styles$B.button, _ === b && styles$B.isActive),
                            onClick: () => p(b),
      ...
      t === 0 ? (r = 10) : t === 1 ? (r = 11) : (r = t),
        jsxs(
          motion.div,
          {
            ...
            transition: {
              ease: 'easeOut',
              duration: 0.5 + durationStep[Math.floor(Math.random() * durationStep.length)],
              delay: s * 0.1
            },
  ...
  SkeletonImage = ({className: e, width: t, height: s, borderRadius: n}) =>
    jsx(motion.div, {
      ...
      animate: 'enter',
      variants,
      style: {width: `${t}px`, height: `${s}px`, borderRadius: `${n}px`},
...
const getSkinDetails = (e) => (skinsData[e] ? skinsData[e] : {
    title: 'Boost',
    description: 'Boost description',
    icon: '🎁'
  }),
  ...
  SkinItem = ({skin: skin, skinStatus: t, onClick: s}) => {
    ...
    t === SkinStatusEnum.enabled && (l = jsx('div', {
          ...
          ? jsxs('div', {
            ...
            children: [
              ...
              jsx(Text, {
                ...
                align: 'center',
                color: 'white',
                children: getSkinDetails(s.image).title
              }),
              jsx(Text, {
                type: 'subheadline-1',
                margin: '0-0-24-0',
                align: 'center',
                color: 'secondary',
                children: getSkinDetails(s.image).description
              }),
              r
                ? null
                : jsx('div', {
              ...
              r ? jsx(Button, {type: 'Blue', onClick: () => c(), children: 'Apply Skin'}) : jsx(Button, {
                type: 'Blue',
                onClick: () => a(),
                children: 'Get'
              }),
  ...
  return (
    reactExports.useEffect(() => {
      ...
      jsxs('div', {
        ...
        children: [a, jsx('div', {className: cn(styles$w.activeBar), style: d})]
      })
  );
}
    ...
    return jsxs('div', {
      ...
      children: [
        jsxs('div', {
          ...
          children: [jsx('div', {className: styles$u.title, children: r}), jsx('div', {
      ...
      ? jsxs(Fragment, {
        children: [
          ...
          jsx(Content, {
            ...
            children: m.map((u, y) => jsx(TaskDailyItem, {task: u, onClick: () => _(u)}, `task-${u.id}`))
          }),
        ],
      })
      : null;
        ...
        ? jsxs('div', {
          ...
          children: [
            ...
            jsx('div', {
              ...
              children: jsx('div', {className: cn(styles$s.cardTitle, styles$s.score), children: 'Free'})
            }),
        ...
        children: [
          jsxs(Content, {
            ...
            children: [
              jsxs(Button$1, {
                type: 'basic',
                onClick: () => e.openTelegramLink('https://t.me/NFCoin_bot'),
                children: [jsx(Icon, {name: 'telegram'}), ' Join']
              }),
              jsxs(Button$1, {
                type: 'basic',
                onClick: () => e.openLink('https://twitter.com/foxhustle_twi'),
                children: [jsx(Icon, {name: 'x', colorFill: 'primary'}), ' Follow']
              }),
            ],
          }),
          jsxs('div', {
            ...
            children: [
              jsx(Content, {
                column: !0,
                className: styles$r.title,
                children: jsx(Text, {type: 'title-large', align: 'center', children: 'NFCoin'})
              }),
              jsxs(Content, {
                spacingChild: '40',
                column: !0,
                        ...
                        jsxs(Content, {
                          ...
                          children: [
                            jsx(Text, {
                              type: 'callout',
                              semibold: !0,
                              children: ClickerBoostsExplanationPageL10n[s].oneTitle
                            }),
                        ...
                        jsxs(Content, {
                          ...
                          children: [
                            jsx(Text, {
                              type: 'callout',
                              semibold: !0,
                              children: ClickerBoostsExplanationPageL10n[s].twoTitle
                            }),
                        ...
                        jsxs(Content, {
                          ...
                          children: [
                            jsx(Text, {
                              type: 'callout',
                              semibold: !0,
                              children: ClickerBoostsExplanationPageL10n[s].threeTitle
                            }),
                        ...
                        jsxs(Content, {
                          ...
                          children: [
                            jsx(Text, {
                              type: 'callout',
                              semibold: !0,
                              children: ClickerBoostsExplanationPageL10n[s].fourTitle
                            }),
          ...
          jsx(Button$1, {
            ...
            onClick: n,
            fixedBottom: !0,
            children: ClickerBoostsExplanationPageL10n[s].button
          }),
        ],
      }),
    ],
...
function Score({score: e, size: t = 48, duration: s = 1}) {
  ...
  return jsxs('div', {
    className: cn(styles$q.score, styles$q[`size-${t}`]),
              ...
              jsxs('div', {
                ...
                children: [
                  jsx('div', {
                    ...
                    children: jsx('div', {className: styles$p.icon, children: '🤝'})
                  }),
            ...
            children: jsxs('div', {
              ...
              children: [
                ...
                jsx('svg', {
                  ...
                  children: jsx('circle', {className: styles$o.cooldownCircle, r: '140', cx: '150', cy: '150'})
                }),
              ],
            }),
          },
    ...
    return jsx(AnimatePresence, {
      children:
        ...
        jsx(motion.div, {
          ...
          exit: {opacity: 0},
          transition: {
            backgroundPositionY: {duration: 7, ease: 'linear', repeat: 1 / 0},
          ...
          ? jsxs(Content, {
            ...
            children: [
              ...
              jsx(Content, {
                ...
                padding: '16-0-12',
                spacingChild: '2',
                children: jsx(Text, {type: 'title-3', weight: 'semibold', children: 'Free daily boosters'})
              }),
              jsx(Content, {
                padding: '0-0-14',
                className: styles$j.taskCarouselWrap,
                children: jsx(TaskCarousel, {onSuccess: p})
              }),
              jsx(Content, {
                column: !0,
                padding: '16-0-12',
                spacingChild: '2',
                children: jsx(Text, {type: 'title-2', weight: 'semibold', children: 'Boosters'})
              }),
              jsx(Content, {
                padding: '0-0-24',
                className: styles$j.taskCarouselWrap,
                children: jsx(BoostCarousel, {onSuccess: p})
              }),
              jsxs(Text, {
                type: 'footnote',
                margin: '0-0-12-0',
                ...
                children: ['Built by', ' ', jsx('a', {
                  href: 'https://antonzlo.github.io',
                  target: '_blank',
                  style: {color: '#feb803'},
                  children: 'Anton Zlobin'
                }), ' & ', jsx('a', {
                  href: 'https://foxhustle.site',
                  target: '_blank',
                  style: {color: '#feb803'},
                  children: 'FoxHustle'
                })],
    ...
    useInterval(async () => {
      if (S && E) {
        ...
        if (w && q && q.isCompleted) {
          ...
          P(null), M.ok && (await d(), r(), o({
            message: `Task is done +${beautifyMoney$1(String(S.coins))} NFCoin`,
            type: 'success'
          }));
        }
      }
      ...
      T = jsxs(Fragment, {
        children: [
          jsx(Content, {
            ...
            padding: '16-0-12',
            spacingChild: '2',
            children: jsx(Text, {type: 'title-2', weight: 'semibold', children: 'Onboarding'})
          }),
          jsx(Content, {
            padding: '0-0-24',
            children: jsx(List, {
              type: 'inset',
              children: onboarding.map((x) => jsx(TaskEarn, {
                task: x,
                userBoosts: [],
                ...
                children: jsx(List, {
                  ...
                  children: jsx(ListItem, {
                    ...
                    before: jsx(MediaIcon, {
                      media: {type: 'cover-emoji', value: '🤝', color: 'pale-grey'},
                      imageSize: '72',
                      size: '72',
                      borderRadius: '12'
                    }),
      ...
      n
        ? jsxs(Content, {
          ...
          children: [
            jsx(Content, {
              padding: '0-0-32-0',
              children: jsx(Text, {type: 'title-large', center: !0, children: ClickerFrensDetailsPageL10n[s].title})
            }),
            jsxs(Content, {
              spacingChild: '32',
              column: !0,
                      ...
                      children: [
                        ...
                        jsxs(Text, {
                          children: [jsx(Penny, {
                            text: '2,500',
                            yellow: !0
                          }), ' ', ClickerFrensDetailsPageL10n[s].inviteDescr]
                        }),
                      ],
                    }),
                  ],
                      ...
                      children: [
                        ...
                        jsxs(Text, {
                          children: [jsx(Penny, {
                            text: '50,000',
                            yellow: !0
                          }), ' ', ClickerFrensDetailsPageL10n[s].premiumDescr]
                        }),
                      ],
                    }),
                  ],
            ...
            jsx(Content, {
              ...
              children: jsx(Text, {
                type: 'title-large',
                center: !0,
                children: ClickerFrensDetailsPageL10n[s].levelUpTitle
              })
            }),
            jsxs('div', {
              children: [
                ...
                jsxs('div', {
                  ...
                  children: [
                    jsxs('div', {
                      ...
                      children: [
                        jsx('img', {
                          src: 'https://yescoin.space/clicker/league/Silver.png',
                          height: '16',
                          alt: 'League cup',
                ...
                jsxs('div', {
                  ...
                  children: [
                    jsxs('div', {
                      ...
                      children: [
                        jsx('img', {
                          src: 'https://yescoin.space/clicker/league/Gold.png',
                          height: '16',
                          alt: 'League cup',
                          className: styles$g.cup
                        }),
                ...
                jsxs('div', {
                  ...
                  children: [
                    jsxs('div', {
                      ...
                      children: [
                        jsx('img', {
                          src: 'https://yescoin.space/clicker/league/Platinum.png',
                          height: '16',
                          alt: 'League cup',
                          className: styles$g.cup
                        }),
                ...
                jsxs('div', {
                  ...
                  children: [
                    jsxs('div', {
                      ...
                      children: [
                        jsx('img', {
                          src: 'https://yescoin.space/clicker/league/Diamond.png',
                          height: '16',
                          alt: 'League cup',
                          className: styles$g.cup
                        }),
            ...
            jsx(Button$1, {
              ...
              fixedBottom: !0,
              children: ClickerFrensDetailsPageL10n[s].button
            }),
          ],
        })
        : null,
...
function ClickerFrensPage() {
  const e = useNavigate(),
    ...
    load = async () => {
      ...
      stats.ok && setStats({
        score: stats.data.bonus ? stats.data.bonus : 0,
        amount: stats.data.count ? stats.data.count : 0,
        rank: stats.data.rank ? stats.data.rank : 0
      }),
      frens &&
      (frens.sort((a, b) => {
          ...
          children: [
            jsx(Text, {
              ...
              children: jsxs(Content, {
                ...
                spacingChild: '12',
                children: [
                  settats !== null && settats.amount > 0 ? jsxs(Content, {
                    justify: 'center',
                    children: [settats.amount, ' Fren', settats.amount > 1 ? 's' : '']
                  }) : 'Fren zone',
                ],
              }),
            }),
...
const title$7 = '_title_1fzam_1',
        ...
        children: jsxs('div', {
          ...
          children: [
            ...
            jsx(Text, {
              ...
              children: jsx('code', {children: e.split('https://')[1]})
            }),
  ...
  ukranian$5 = {
    ...
    subtitle: jsxs(Fragment, {children: ['Запросіть побільше друзів', jsx('br', {}), 'щоб попасти сюди']}),
  ...
  ClickerLeagueInfluencerPageL10n = {
    ...
    ru: {
      ...
      subtitle: jsxs(Fragment, {children: ['Приглашай больше друзей', jsx('br', {}), 'чтобы попасть сюда']}),
      button: 'Пригласить друзей'
    },
    tr: {
      title: 'Parti Kralları',
      subtitle: jsxs(Fragment, {children: ['Davet et ve daha fazla', jsx('br', {}), 'arkadaşın buraya gelsin']}),
              ...
              jsxs(Content, {
                ...
                children: [
                  ...
                  jsx(Text, {
                    ...
                    center: !0,
                    color: 'secondary',
                    children: ClickerLeagueInfluencerPageL10n[s].subtitle
                  }),
                  jsx(Content, {
                    fullWidth: !0,
                    growChild: !0,
                    ...
                    children: jsx(Button$1, {
                      type: 'orange',
                      onClick: inviteFrenViaBotStartRef,
                      children: ClickerLeagueInfluencerPageL10n[s].button
                    }),
                  }),
                ],
              }),
                ...
                jsxs('div', {
                  ...
                  children: [
                    ...
                    jsxs('div', {
                      ...
                      children: [jsx('div', {className: styles$d.online}), ' Online']
                    }),
                  ],
                }),
              ],
  ...
  const getLEaderboard = async () => {
      ...
      const {ok: w, items: items} = isSkvad
        ...
        : await fetchLeaderboard({
          ...
          league: i.enum,
          time: T,
          squadId: (s === 'team' && (u == null ? void 0 : u.teamId)) || void 0
        });
      if (w) {
        if ((isSkvad || s === 'user') && v) {
          const R = z.rank,
                ...
                jsxs(Content, {
                  ...
                  children: [
                    ...
                    v ? null : jsx(Content, {
                      ...
                      children: getLeagueDescription(i, x)
                    }),
                  ],
                }),
                jsxs(Content, {
                  ...
                  column: !0,
                  children: [
                    isSkvad ? null : jsxs(Tabs, {
                      onChange: f,
                      activeIndex: o,
                      className: styles$n.tabs,
                      children: [jsx(Tab, {label: 'Miners'}), jsx(Tab, {label: 'Squads'})]
                    }),
                    t === '1'
                      ? jsxs(Text, {
...
const ukranian$4 = {
  ...
  LeagueSquadPageL10n = {
    en: {
      title: 'Join Squad!',
      subtitle: jsxs(Fragment, {children: ['These squads recruiting now.', jsx('br', {}), ' Do you wanna join?']}),
              ...
              jsxs(Content, {
                ...
                children: [
                  ...
                  jsx(Text, {
                    ...
                    center: !0,
                    color: 'secondary',
                    children: LeagueSquadPageL10n[t].subtitle
                  }),
                  jsx(Content, {
                    fullWidth: !0,
                    growChild: !0,
                ...
                children: s.map((d) =>
                  jsx(
                    ListItem,
                    {
                        ...
                        children: [
                          ...
                          l
                            ? jsxs(Content, {
                              ...
                              children: [jsx('div', {children: '・'}), jsxs('p', {
                      ...
                      before: jsx(MediaIcon, {
                        media: {type: 'cover-src', value: d.team.logo, color: 'pale-grey'},
                        imageSize: '48',
                        size: '48',
                        borderRadius: '12'
                      }),
            ...
            jsxs('div', {
              ...
              children: [
                ...
                jsx('div', {
                  ...
                  children: t > 0 ? `+${beautifyMoney$1(t)}` : jsx(Skeleton.Line, {className: styles$a.scoreSkeleton})
                }),
  ...
  return jsxs(Page, {
    ...
    children: [
      ...
      jsx(TurboPussy, {
        ...
        times: turboTimes,
        onClick: onRocket,
        multiple: turboSettings == null ? -1 : turboSettings.multiple
      }),
      ...
      jsxs(Content, {
        ...
        children: [
          ...
          jsx(Content, {
            ...
            align: 'center',
            column: !0,
            children: jsx(PlaceAndLeague, {leagueId: userProfile == null ? void 0 : userProfile.leagueId})
          }),
        ],
      }),
      newbie && jsx('div', {style: {height: '195px'}}),
      jsx(Notcoin, {
        canIClickPlease: okToClick,
        sleep: isSleep,
        funMode: isTurbo,
        clickValue: calculateClickValue(isTurbo, turboSettings, clickValue),
        cooldown: cooldown,
        handleClick: I,
        multiple: turboSettings == null ? void 0 : turboSettings.multiple
      }),
        ...
        children: [
          jsxs(Content, {
            ...
            children: [
              jsxs(Button$1, {
                type: 'basic',
                onClick: () => e.openTelegramLink('https://t.me/nfc_main'),
                children: [jsx(Icon, {name: 'telegram'}), ' Join']
              }),
              jsxs(Button$1, {
                type: 'basic',
          ...
          jsxs('div', {
            ...
            children: [
              jsx(Content, {
                ...
                children: jsx(Text, {type: 'title-large', align: 'center', children: 'Squads'})
              }),
              jsxs(Content, {
                spacingChild: '40',
                column: !0,
...
function ClickerSquadPage() {
  ...
  const j = async () => {
    ...
    L = async (S) => {
      c || d();
      const {ok: P, items: I} = await fetchLeaderboard({
        type: 'in-team',
                ...
                ? jsxs(Fragment, {
                  children: [
                    ...
                    jsx(Text, {
                      ...
                      color: 'white',
                      center: !0,
                      children: getSizeMessage(g == null ? void 0 : g.count)
                    }),
                    jsxs(Content, {
                      padding: '16',
                      column: !0,
                      ...
                      children: [
                            ...
                            jsxs(Content, {
                              ...
                              children: [
                                jsx(Text, {
                                  ...
                                  semibold: !0,
                                  noWrap: !0,
                                  children: beautifyLongNumber(g == null ? void 0 : g.count, 'standard')
                                }),
                                jsx(Text, {
                                  type: 'subheadline-1',
                                  color: 'secondary',
                        ...
                        $
                          ...
                          : jsx(Button, {
                            type: 'Blue',
                            onClick: () => t(`/clicker/squad-join/${m}`),
                ...
                children: jsx(Leaderboard, {
                  ...
                  tabs: jsxs(Tabs$1, {
                    ...
                    children: [jsx(Tab$1, {
                      ...
                      flat: !0
                    }), jsx(Tab$1, {label: ClickerSquadPageL10n[l].weekPeriod, flat: !0})],
                  }),
                }),
              }),
            ],
